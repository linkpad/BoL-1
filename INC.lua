...
function LaneClearMode()
	enemyMinions:update()
	if Settings.LaneClear.UseQ and SkillQ.ready and ManaManagement()then
...
function Menu()
	...
	Settings:addSubMenu("["..myHero.charName.."] - LaneClear Settings", "LaneClear")
		...
		Settings.LaneClear:addParam("Mana", "Use (Q) if Mana > X", SCRIPT_PARAM_SLICE, 301, 1, 600, 0)
