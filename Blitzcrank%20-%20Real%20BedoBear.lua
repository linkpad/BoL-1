...
local UPDATE_PATH = "/AMBER17/BoL/master/Blitzcrank%20-%20Real%20BedoBear.lua" .. "?rand=" .. math.random(1, 10000)
...
local UPDATE_HOST = "raw.github.com"
local UPDATE_PATH = "/AMBER17/BoL/master/blitzcrank.lua" .. "?rand=" .. math.random(1, 10000)
local UPDATE_FILE_PATH = SCRIPT_PATH..GetCurrentEnv().FILE_NAME
local UPDATE_URL = "http://"..UPDATE_HOST..UPDATE_PATH
